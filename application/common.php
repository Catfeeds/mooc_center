...
function getUserInfo(){
    /*if($param['terminal'] == 1){//pc
       $pc_token = input('param.user_token');
       $user_info = db('mooc_user')->where(['user_token' => $pc_token])->find();
   }else if($param['terminal'] == 2){//wx
       $wx_token  = input('param.user_token');
       $user_info = db('mooc_user')->where(['user_token' => $wx_token])->find();
   }else if($param['terminal'] == 2){//app
       $app_token  = input('param.user_token');
       $user_info = db('mooc_user')->where(['user_token' => $app_token])->find();
   }*/
