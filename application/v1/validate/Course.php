...
class Course extends Validate
{
    ...
    protected $message = [
        ...
        'course_id.requireEdit' => '课程ID必须',
        'course_id.number' => '课程类型必须是数字',
...
//        'course_from.between'  =>  '课程来源错误',
    ...
    protected $scene = [
        ...
        'edit' => ['course_id', 'mooc_id', 'course_title', 'cover_img', 'cover_video', 'open_status', 'start_time', 'end_time', 'content', 'status', 'create_time'],
    ];
